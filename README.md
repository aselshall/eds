...
- [Pandas](https://pandas.pydata.org/) for spreadsheet analysis
- [Matplotlib](https://matplotlib.org/) for plotting
- [NumPy](https://numpy.org/) for scientific computing
- [Xarray](https://xarray.dev/) for multi-dimensional geospatial data analysis
- [Cartopy](https://pypi.org/project/Cartopy/) for geospatial data visualization

You will learn how to use these tools for analyzing and visualizing water and environmental data. We will explore data from various sources such as [NOAA](https://data.noaa.gov/onestop/), [NASA](https://data.nasa.gov/browse), [Copernicus](https://www.copernicus.eu/en/accessing-data-where-and-how/copernicus-services-catalogue), [USGS](https://www.sciencebase.gov/catalog/), and [Data.Gov](https://data.gov), handling formats such as [CSV](https://en.wikipedia.org/wiki/Comma-separated_values) , [shapefile](https://en.wikipedia.org/wiki/Shapefile) , and [NetCDF](https://en.wikipedia.org/wiki/NetCDF). By the end of the course, you will be able to perform data analysis and visualization with Python to address treal-world water resources and environmental challenges. No prior programming experience is required. 
...
|      | 3      | 15-Jan    | Python basics 1 - Variables and functions          |                            |
| 3    |        | 19-Jan    | MLK Holiday Observed (no classes)- Monday          |                            |
|      | 4      | 20-Jan    | Python basics 2 - Python data structures           |                            |
|      | 5      | 22-Jan    | Python basics 3 - Text formatting                  |                            |
| 4    | 6      | 27-Jan    | Python programming 1 - Loops                       | [HW1 Basics](https://aselshall.github.io/edsbook/Chapters/2.%20Python%20Basics/HW1.html)                 |
|      | 7      | 29-Jan     | Python programming 2 - Conditional statements      |                            |
| 5    | 8      | 3-Feb     | Python programming 3 - Functions                   |                            |
|      | 9      | 5-Feb    | Python programming 4 - Modules                     |                            |
| 6    | 10     | 10-Feb    | Pandas 1 - Pandas for programmable spreadsheet     | [HW2 Programming](https://aselshall.github.io/edsbook/Chapters/3.%20Python%20Programming/HW2.html)            |
|      | 11     | 12-Feb    | Pandas 2 - Filtering by keyword and dataFrame index|                            |
| 7    | 12     | 17-Feb    | Pandas 3 - Descriptive statistics and slicing      |                            |
|      | 13     | 19-Feb    | Pandas 4 - Dicing and datetime column subsetting   |                            |
| 8    | 14     | 24-Feb    | Pandas 5 - Quick plots and save & load dataFrame   |                            |
|      | 15     | 26-Feb    | Data science workflow                              | [HW3 Pandas](https://aselshall.github.io/edsbook/Chapters/4.%20Pandas%20for%20Tabular%20Data/HW3.html)                 |
| 9    |        | 3-Mar     | Spring Break                                       |                            |
|      |        | 5-Mar     | Spring Break                                       |                            |
| 10   | 16     | 10 Mar    | Data science workflow                              | [Project summary](https://aselshall.github.io/eds/HW/project#13-schedule-and-assessment)            |
|      | 17     | 12-Mar    | NumPy for scientific computing                     |                            |
| 11   | 18     | 17-Mar    | NumPy for scientific computing                     |                            |
|      | 19     | 19-Mar    | NumPy for scientific computing                     |                            |
| 12   | 20     | 24-Mar    | Matplotlib for data visualization                  |                            |
|      | 21     | 26-Mar    | Matplotlib for data visualizationb                 |                            |
| 13   | 22     | 31-Mar    | Matplotlib for data visualization                  |                            |
|      | 23     | 2- Apr    | ST: Climate data - CMIP6 and remote sensing        | [HW4 NumPy and Matplotlib](https://aselshall.github.io/edsbook/Chapters/8.%20Matplotlib%20for%20Visualization/HW4.html)   |
| 14   | 24     | 7-Apr     | ST: Xarray for n-dimensional geospatial data       |                            |
|      | 25     | 9-Apr     | ST: Xarray for n-dimensional geospatial data       | [Interim report](https://aselshall.github.io/eds/HW/project#13-schedule-and-assessment)             |
...
## [Term Project](https://aselshall.github.io/eds/HW/#term-project)
