...
You can search for a community partner that aligns with your interests in the [FGCU Community Partners Database](https://servicelearning.fgcu.edu/CommunityPartnerDatabase/agencieslist). Potential partners include the Florida Department of Environmental Protection, U.S. Army Corps of Engineers, FGCU, or similar organizations. Alternatively, you can contribute to an FGCU research project such as:
- **[Nature-based solutions and groundwater level trends in South Florida](https://aselshall.github.io/eds/HW/project/nbi)**: Involves land-use and land-cover (LULC) change, nature-based infrastrcture, groundwater hydrology, and Google Earth engine.
- **[Evaluation of downscaled climate data for South Florida](https://aselshall.github.io/eds/HW/project/downscaled-climate-data)**: Inovolves global climate models, weather station data analysis, and data for historic and future data for hydrologic modeling
...
GitHub is not designed to host large geospatial datasets (e.g., shapefiles, rasters). Zipping does not resolve the size limits (100 MB per file, ~1–2 GB practical repo size). For large shapefiles/maps, better option would be Zenodo. There are also Figshare, OSF, or Google Drive. Upload the data there and link it in your GitHub repo.
