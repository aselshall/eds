...
You are expected to conduct a project using Python on a water or environmental issue of your choice. You should develop a research question or problem statement that guides your analysis. You need to use Python and its various libraries to process, analyze, and visualize data to answer your research question or solve the industry-oriented problem. Graduate student may work individually or in group of up to three. Undergraduate student needs to work in a group of two to five. Throughout the project, you will have the opportunity to apply and deepen your skills in data analysis and visualization, critical thinking, and independent learning, in alignment with the project objectives.
...
All students working in a group need to submit the peer-assessment. You only get the peer-assessment grade if you submitted peer-assessment. Use [peer-assessment rubric](https://aselshall.github.io/HW/peer) to evaluate the contribution of each group member. 
...
| **Data Availability (20%)** | Code and data fully documented and shared via GitHub/Binder following best practices. | Code and data reasonably well documented and shared. | Basic code/data sharing with room for improvement. | Code/data sharing attempted but poorly executed. | No code or data sharing. |
